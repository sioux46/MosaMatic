...
const colGauche = 'col-md-6 col-sm-6'; // 'col-lg-6 col-md-7 col-sm-8'; // form
const colDroite = 'col-md-6 col-sm-6'; // 'col-lg-6 col-md-5 col-sm-4'; // mosaic
...
// exemples:
// hexToRgba("#f00");        // rgba(255, 0, 0, 1)
// hexToRgba("#f008");      // rgba(255, 0, 0, 0.53)
// hexToRgba("#ff000080");  // rgba(255, 0, 0, 0.5)
// hexToRgba("#00ff00", 0.3); // rgba(0, 255, 0, 0.3)
...
///////////////////
  ...
  $("#mosaicContainer").on("click", () => {
    if ( $("#anim")[0].checked ) $("#anim").trigger("click");
    else $("#submit").trigger("click");
  });

  // screenshot
  document.getElementById("btnCapture").addEventListener("click", () => {
    const node = document.getElementById("mosaicContainer");
...
//////
  ...
  $("#box").on("change", function () {
    $("#mosaicGridOverlay").toggle(this.checked);
  });
